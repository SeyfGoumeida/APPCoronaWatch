...
class VideoCommentsAdapter (  private val comments: ArrayList<VideoCommentsItem>,val context: Context ):
    RecyclerView.Adapter<VideoCommentsAdapter.ViewHolder>() {
        ...
        class ViewHolder(item: View, val context: Context): RecyclerView.ViewHolder(item){
            ...
            fun initialize(item: VideoCommentsItem){
